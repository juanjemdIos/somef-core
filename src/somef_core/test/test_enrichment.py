...
class TestEnrichment(unittest.TestCase):
    ...
    @patch("somef_core.utils.enrichment.search_openalex_author")
    ...
    @patch("somef_core.utils.enrichment.get_openaire_project")
    ...
    @patch("somef_core.utils.enrichment.get_openalex_id")
    @patch("somef_core.utils.enrichment.get_openaire_id")
