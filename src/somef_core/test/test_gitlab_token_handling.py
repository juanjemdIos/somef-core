...
class TestGitlabTokenHandling(unittest.TestCase):
    @patch("somef_core.parser.codeowners_parser.requests.get")
    ...
    @patch("somef_core.somef_cli.verify_and_resolve_token", return_value="Bearer token-456")
    @patch("somef_core.somef_cli.json_export.unify_results", return_value={})
    @patch("somef_core.somef_cli.cli_get_data")
    @patch("somef_core.somef_cli.validators.url", return_value=True)
    ...
    @patch("somef_core.somef_cli.verify_and_resolve_token", return_value="Bearer token-123")
    @patch("somef_core.somef_cli.json_export.unify_results", return_value={})
    @patch("somef_core.somef_cli.cli_get_data")
    @patch("somef_core.somef_cli.validators.url", return_value=True)
