...
class TestTokenVerification(unittest.TestCase):
    ...
    @patch("somef_core.somef_cli.process_repository.is_gitlab", return_value=True)
    ...
    @patch("somef_core.somef_cli.requests.get")
    ...
    @patch("somef_core.somef_cli.verify_and_resolve_token", return_value="token test-abc")
